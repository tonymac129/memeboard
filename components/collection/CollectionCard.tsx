...
function CollectionCard({ collection }: { collection: CollectionType }) {
  return (
    <Link
      ...
      className="flex flex-col gap-y-3 w-55 border-2 border-zinc-700 rounded p-4 pb-7 font-bold text-lg text-white hover:bg-zinc-900"
    >
      ...
      {collection.memes.length > 0 ? (
        <div className="flex flex-col items-center w-full relative">
          ...
          <div className="absolute -bottom-1.5 w-[92%] rounded bg-zinc-700 h-10" />
          <Image
        ...
        <div className="w-full rounded bg-zinc-800 h-40 flex items-center font-normal text-zinc-300 text-sm px-4 py-2 text-center">
